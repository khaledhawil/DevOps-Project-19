...
# # Local provisioner to create Ansible inventory
# resource "local_file" "ansible_inventory" {
#   content = templatefile("${path.module}/../ansible/inventory/hosts.template", {
#     jenkins_ip = module.ec2_instance.public_ip
#   })
...
#       ansible-playbook -i inventory/hosts jenkins-setup-simple.yml -v
#     EOT
#   }
# }